#!/usr/bin/env python3
"""
Script to analyze Daniel Priestley video transcripts using Anthropic Batch API
"""
...
def load_transcript_summary(json_file):
    """Load transcript summary from JSON file"""
...
def create_batch_requests(json_files, script_dir):
...
def main():
    ...
    print("=" * 60)
    print("Daniel Priestley Transcript Analyzer (Batch Mode)")
    print("=" * 60)
    ...
    requests_data = create_batch_requests(json_files, script_dir)
